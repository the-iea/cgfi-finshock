...
export const getTutorial = (tour: any, store: Store<string, State>) => [
	{
		id: 'intro',
		title: 'Welcome!',
		text: 'This Network Reevaluation Model is a tool for visualizing and analyzing shocks to financial networks. If you are new to the model, we recommend you follow this tutorial to learn how to use it.',
		cancelIcon: {
			enabled: true,
		},
